package com.justzaap.auth.security.model;
...
public class RolePermissionPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		return this.rolePermissionId.equals(castOther.rolePermissionId)
				&& this.permissionId.equals(castOther.permissionId) && this.roleId.equals(castOther.roleId);
	}
